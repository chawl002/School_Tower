...
public class ItemDatabase : MonoBehaviour {
	...
	void Start()
	{
		...
		items.Add (new Item ("BigF", 7, "Instantly defeats an enemy, but at a hefty cost, can you risk it? Unlocked by defeating a Professor F.", 100, 8, 0, Item.ItemType.Weapon, 100, "BigFKid"));
	}
}
